...
--><!--                <li><a href="http://www.script-tutorials.com/whirling-dropdown-menu/">Back to tutorial</a></li>
    ...
    <div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					<h2>Office Automation Web Based Application</h2>
					<p>Office Automation has come a long way. The term refers to the combination of tools available to create, store, manipulate and relay office information over a network. But, what started out primarilyas aword processing, data processing and e-mail has now moved on to more sophiscated office automation tasks such as advanced copying, scanning, and printing processes that integrate front office and back office systems and processes. Modern office automation can save time and money while reducing paper waste and power consumption.</p>
