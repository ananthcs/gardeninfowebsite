...
<html lang="en">
    ...
    <!--<div class="container2" id="main" role="main">
            <ul class="menu">
                <li><a href="#">Home</a></li>
                <li><a href="#s1">Products</a>
                    <ul class="submenu">
                        <li><a href="#">Office Automation</a></li>
                        <li><a href="#">Production Management System</a></li>
                        <li><a href="#">Restaurant Management System</a></li>
                        <li><a href="#">E-Commerce Portal</a></li>
                        <li><a href="#">Vehicle Tracking System</a></li>
                        <li><a href="#">Pay Collecting System</a></li>
                        <li><a href="#">Money Lending System</a></li>
                    </ul>
                </li>
                <li class="active"><a href="#s2">Service</a>
                    <ul class="submenu">
                        <li><a href="#">Android Appication Development</a></li>
                        <li><a href="#">Web Application Development</a></li>
                        <li><a href="#">Device Firmware Development</a></li>
                        <li><a href="#">Business Consulting</a></li>
                    </ul>
                </li>
                <li class="active"><a href="#s3">About</a>
                    <ul class="submenu">
                        <li><a href="#">Contact</a></li>
                        <li><a href="#">Management Profile</a></li>
                        <li><a href="#">Garden E-Shop</a></li>
                    </ul>
                </li>
    ...
    <div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<p>For setting up the E‐commerce portal, we will provide the following services    • Domain Registration for the portal from internationally acclaimed domain resellers. (The  domain mentioned by the customer should be available.)  • Web space registration from public cloud services.  • Email configuration as per the customer requirements.  • E‐commerce portal configuration on the domain.  • Setting up commodities on the portal. Including photo uploading, description and price  adding, etc as per customer requirements.  • Payment gateway integration on the portal. Customer need a current account and should be  KYC complaint as per RBI guidelines.  • Continuous maintenance of the E‐commerce portal. </p>
