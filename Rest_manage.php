    ...
    <div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<p>In order to fulfill the ever changing demands of our clients, we are offering Restaurant KOT Android App. We have an experience professionals engaged in offering Restaurant KOT Android App in the market.</p>
                    <p>
                    Manage your guests in your palm Enable the comfort of attending your guest from their seating to billing by just playing with your... finger. Manage your guest seating, orders, their preferences, priority of serve, merge or split KOT's, and convert them to bill with predefined discounts,supporting fine-dine restaurant, quick service restaurant, bakery and even more food businesses.
                    </p>
                    <h4>APP  Highlights</h4>
<ul>
<li>Easy and intuitive UI </li>
<li>Access all tables on the floor... on the go! </li>
<li>Serve the guests to their order of choices </li>
<li>Serve Dine-in & Takeaway orders </li>
<li>Your guests order to bill </li>
<li>Merge/ shift tables as you please </li>
<li>Choose a table and start taking KOT's</li>
<li>Take the order once with item priority</li>
<li>Repeat order to guest</li>
<li>Convert the KOT's to billing</li>
</ul>
				</div>
