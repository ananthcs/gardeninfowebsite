...
--><!--                <li><a href="http://www.script-tutorials.com/whirling-dropdown-menu/">Back to tutorial</a></li>
    ...
    <div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					<h2>Production Managment System</h2>
					<p>This project is designed for managing Internal Production Unit, Inventory and Finance Management. We include PC / Web Application, Mobile Application (Android) and POS Billing System with basic reports related to the production involved business. </p>
